...
public interface GolfTeamDAO {
	...
	@SQL(" insert into " + table_name + "(name,logo,creator_id,contacts,phone,city,purpose,description,notice,created_date,created_time) value(:1.name,:1.logo,:1.creatorId,:1.contacts,:1.phone,:1.city,:1.purpose,:1.description,:1.notice,:1.createdDate,now())")
