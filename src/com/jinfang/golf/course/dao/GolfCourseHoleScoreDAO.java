...
public interface GolfCourseHoleScoreDAO {
	...
	//数据表字段
	public static String field = "course_id,hole_num,player_id,player_name,serial_num,par_score,total_score,putter_score,sub_score,created_time";

	@SQL(" insert into " + table_name + "(course_id,hole_num,player_id,player_name,serial_num,par_score,total_score,putter_score,sub_score,created_time)values(:1.courseId,:1.holeNum,:1.playerId,:1.playerName,:1.serialNum,:1.parScore,:1.totalScore,:1.putterScore,:1.subScore,now())")
