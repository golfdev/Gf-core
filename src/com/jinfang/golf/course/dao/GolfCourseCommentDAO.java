...
public interface GolfCourseCommentDAO {
	...
	//数据表字段
	public static String field = "id,course_id,content,type,created_time";

	@SQL(" insert into " + table_name + "(course_id,content,type,created_time)values(:1.courseId,:1.content,:1.type,now())")
